...
<body>
    ...
    <div class="container">
        <nav class="row navbar navbar-expand-lg navbar-light bg-white">
            <a href="#" class="navbar-brand"><img src="{{url('frontend/images/logo.png')}}" alt="logo nomades" srcset="" /></a>
    ...
    <footer class="section-footer mt-5 mb-4 border-top">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center align-item-center pt-4">
                <div class="col-auto text-gray-500 font-weight-light">
                    2019 copyright Nomades . All right reserved . Made in Jakarta
                </div>
            </div>
        </div>
    </footer>
