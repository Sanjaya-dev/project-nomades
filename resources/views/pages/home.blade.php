            ...
            <div class="container">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                ...
                                <h3>Angga Rizky</h3>
                                <p class="testimonial">
                                    " It was glorious and could not stop to say wohooo for every
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <a href="{{route('detail',$item->slug)}}" class="btn btn-need-help px-4 mt-4 mx-1">
                            I Need Help
                        </a>
