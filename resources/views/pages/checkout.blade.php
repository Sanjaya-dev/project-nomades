                    ...
                    <div class="card card-details">
                            ...
                            <table class="table table-responsive-sm text-center">
                                ...
                                <tbody>
                                    @forelse ($item->details as $detail)
                                        <tr>
                                            <td>
                                                <img src="https://ui-avatars.com/api/?name={{$detail->username}}" height="60" class="ronded-circle">
                                            </td>
                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline" action="{{route('checkout-create',$item->id)}}" method="POST">
                                ...
                                <select name="is_visa" id="is_visa" class="custom-select form-control mb-2 mr-sm-2" required>
                            ...
                            <p class="disclamer mb-0">
                                You are only able to invite mamber that has registered in Nomads
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-details card-right">
                        ...
                        <table class="trip-information">
                            ...
                            <tr>
                                ...
                                <td width="50%" class="text-right">$ {{$item->travel_package->price}},00 / persone</td>
                            </tr>
                            <tr>
